...
parser.add_argument("--prep_data", type=str, default="/data", help="Path to data directory")
parser.add_argument("--prep_results", type=str, default="/data", help="Path for saving results directory")
parser.add_argument(
    "--prep_exec_mode",
    type=str,
    default="test",
...
if __name__ == "__main__":
    ...
    path = os.path.join(args["prep_data"], task_code)
    if args["prep_exec_mode"] == "test":
